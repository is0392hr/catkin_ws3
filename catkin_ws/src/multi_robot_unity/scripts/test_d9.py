...
class Follower:
    def __init__(self):
        ...
        image = rospy.Subscriber('/unity_image/compressed_d9', CompressedImage, self.image_callback)
    ...
    def callback(self, data):
        ...
        if d09_posZ < 2 and dist_19 > 15:
            ...
            control = [-0.1*(d09_posX-d01_posX),-0.1*(d09_posY-d01_posY),-0.2*(d09_posZ-3)]
            print("ATR APPEAR!!")
        else:
        
            if d09_posZ >= 3 and curr_time > 10:
            ...
            new_velX = velX - repul
            calc_odom = (Vector3(new_velX,velY,-2.0*(d09_posZ-5)))
            control = [new_velX,velY,-2.0*(d09_posZ-5)]
