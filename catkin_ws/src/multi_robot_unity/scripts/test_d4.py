...
class Follower:
    ...
    def callback(self, data):
        ...
        if d04_posZ < 2 and dist_24 > 15:
            ...
            control = [-0.1*(d04_posX-d02_posX),-0.1*(d04_posY-d02_posY),-0.2*(d04_posZ-3)]
            print("ATR APPEAR!!")

        else:
            if d04_posZ >= 3 and curr_time > 10:
            ...
            control = [new_velX, velY, -2.0*(d04_posZ-5)]
            calc_odom = (Vector3(new_velX,velY,-2.0*(d04_posZ-5)))
