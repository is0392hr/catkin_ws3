...
class Follower:
    ...
    def callback(self, data):
        ...
        print('D5_', dist_45)
        if d05_posZ < 3 and dist_45 > 15:
            calc_odom = (Vector3(-0.5*(d05_posX-d04_posX),-0.5*(d05_posY-d04_posY),-0.2*(d05_posZ-3)))
            control = [-0.5*(d05_posX-d04_posX),-0.5*(d05_posY-d04_posY),-0.2*(d05_posZ-3)]
            print("ATR APPEAR!!")
        else:
            ...
            control = [new_velX,velY,-2.0*(d05_posZ-5)]
            calc_odom = (Vector3(new_velX,velY,-2.0*(d05_posZ-5)))
