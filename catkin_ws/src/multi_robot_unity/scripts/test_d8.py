...
class Follower:
    def __init__(self):
        ...
        image = rospy.Subscriber('/unity_image/compressed_d8', CompressedImage, self.image_callback)
    ...
    def callback(self, data):
        ...
        if d08_posZ < 2 and dist_98 > 15:
            ...
            control = [-0.1*(d08_posX-d09_posX),-0.1*(d08_posY-d09_posY),-0.2*(d08_posZ-3)]
            print("ATR APPEAR!!")

        else:
            if d08_posZ >= 3 and curr_time > 10:
            ...
            new_velX = velX - repul
            control = [new_velX,velY,-2.0*(d08_posZ-5)]
            calc_odom = (Vector3(new_velX,velY,-2.0*(d08_posZ-5)))
