...
def callback(data):
    ...
    t_velLin_x = data.twist[2].linear.x
    t_velLin_y = data.twist[2].linear.y
    ...
    d3_orienX = data.pose[5].orientation.x
    d3_orienY = data.pose[5].orientation.y
    d3_orienZ = data.pose[5].orientation.z
    d3_orienW = data.pose[5].orientation.w
    d3_velLin = data.twist[5].linear
    d3_velAngular = data.twist[5].angular
    d3_posX = data.pose[5].position.x
    d3_posY = data.pose[5].position.y
    d3_posZ = data.pose[5].position.z
