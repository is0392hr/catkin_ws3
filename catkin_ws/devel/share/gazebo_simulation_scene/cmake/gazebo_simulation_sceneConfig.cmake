...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_simulation_scene_SOURCE_PREFIX /home/koki/catkin_ws/src/gazebo_simulation_scene)
  set(gazebo_simulation_scene_DEVEL_PREFIX /home/koki/catkin_ws/devel)
  ...
  set(gazebo_simulation_scene_INSTALL_PREFIX /home/koki/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_simulation_scene' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/koki/catkin_ws/src/gazebo_simulation_scene/${idir}'.  ${_report}")
    endif()
