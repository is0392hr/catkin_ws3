...
get_filename_component(_filename "/home/koki/ros_catkin_ws/src/rosauth/srv/Authentication.srv" NAME_WE)
add_custom_target(_rosauth_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rosauth" "/home/koki/ros_catkin_ws/src/rosauth/srv/Authentication.srv" ""
)
...
_generate_srv_cpp(rosauth
  "/home/koki/ros_catkin_ws/src/rosauth/srv/Authentication.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rosauth)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rosauth\")")
  # install generated code
  install(
