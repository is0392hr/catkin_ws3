...
if("TRUE" STREQUAL "TRUE")
  set(rostest_SOURCE_PREFIX /home/koki/ros_catkin_ws/src/ros_comm/rostest)
  set(rostest_DEVEL_PREFIX /home/koki/ros_catkin_ws/devel_isolated/rostest)
  set(rostest_INSTALL_PREFIX "")
  set(rostest_PREFIX ${rostest_DEVEL_PREFIX})
else()
  set(rostest_SOURCE_PREFIX "")
  set(rostest_DEVEL_PREFIX "")
  set(rostest_INSTALL_PREFIX /home/koki/ros_catkin_ws/install_isolated)
...
if(NOT "/home/koki/ros_catkin_ws/src/ros_comm/rostest/include;/usr/include " STREQUAL " ")
  set(rostest_INCLUDE_DIRS "")
  set(_include_dirs "/home/koki/ros_catkin_ws/src/ros_comm/rostest/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rostest' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/koki/ros_catkin_ws/src/ros_comm/rostest/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rostest_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/lib/x86_64-linux-gnu/libboost_system.so;/usr/lib/x86_64-linux-gnu/libboost_thread.so;-lpthread;/usr/lib/x86_64-linux-gnu/libboost_chrono.so;/usr/lib/x86_64-linux-gnu/libboost_date_time.so;/usr/lib/x86_64-linux-gnu/libboost_atomic.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/koki/ros_catkin_ws/devel_isolated/rostest/lib;/home/koki/ros_catkin_ws/install_isolated/lib;/home/koki/catkin_ws/devel/lib)
