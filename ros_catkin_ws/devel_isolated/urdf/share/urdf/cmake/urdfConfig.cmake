...
if("TRUE" STREQUAL "TRUE")
  set(urdf_SOURCE_PREFIX /home/koki/ros_catkin_ws/src/urdf/urdf)
  set(urdf_DEVEL_PREFIX /home/koki/ros_catkin_ws/devel_isolated/urdf)
  set(urdf_INSTALL_PREFIX "")
  set(urdf_PREFIX ${urdf_DEVEL_PREFIX})
else()
  set(urdf_SOURCE_PREFIX "")
  set(urdf_DEVEL_PREFIX "")
  set(urdf_INSTALL_PREFIX /home/koki/ros_catkin_ws/install_isolated)
...
if(NOT "/home/koki/ros_catkin_ws/src/urdf/urdf/include;/home/koki/ros_catkin_ws/devel_isolated/urdf/include;/usr/include " STREQUAL " ")
  set(urdf_INCLUDE_DIRS "")
  set(_include_dirs "/home/koki/ros_catkin_ws/src/urdf/urdf/include;/home/koki/ros_catkin_ws/devel_isolated/urdf/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/koki/ros_catkin_ws/src/urdf/urdf/${idir}'.  ${_report}")
    endif()
    _list_append_unique(urdf_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "urdf;/usr/lib/x86_64-linux-gnu/liburdfdom_sensor.so;/usr/lib/x86_64-linux-gnu/liburdfdom_model_state.so;/usr/lib/x86_64-linux-gnu/liburdfdom_model.so;/usr/lib/x86_64-linux-gnu/liburdfdom_world.so;/usr/lib/x86_64-linux-gnu/libconsole_bridge.so.0.4;/usr/lib/x86_64-linux-gnu/libboost_thread.so;-lpthread;/usr/lib/x86_64-linux-gnu/libboost_chrono.so;/usr/lib/x86_64-linux-gnu/libboost_system.so;/usr/lib/x86_64-linux-gnu/libboost_date_time.so;/usr/lib/x86_64-linux-gnu/libboost_atomic.so;/usr/lib/x86_64-linux-gnu/libtinyxml.so;/usr/lib/x86_64-linux-gnu/libtinyxml2.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/koki/ros_catkin_ws/devel_isolated/urdf/lib;/home/koki/ros_catkin_ws/install_isolated/lib;/home/koki/catkin_ws/devel/lib)
